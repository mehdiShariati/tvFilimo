...
if(!payload) return;
 try {
    ...
    const checkAuth=yield axios.get(`https://cors-anywhere.herokuapp.com/https://www.filimo.com/etc/api/verifycodecheck/ref_type/tv/code/${payload}/devicetype/tvweb`);
        ...
        if(!checkAuth.data.verifycodecheck.hasOwnProperty('type')){
            ...
            const userProfile=yield axios.get(`https://cors-anywhere.herokuapp.com/https://www.filimo.com/etc/api/profileaccount/luser/${checkAuth.data.verifycodecheck.username}/ltoken/${checkAuth.data.verifycodecheck.ltoken}/devicetype/tvweb`);
...
const IntervalChecker=(payload)=>{
    ...
    setTimeout(()=>{
        const checkAuth= axios.get(`https://cors-anywhere.herokuapp.com/https://www.filimo.com/etc/api/verifycodecheck/ref_type/tv/code/${payload}/devicetype/tvweb`);
